			...
			return {
				on: {
					init: function () {
						...
						qodef.body.trigger(
							'askka_trigger_swiper_is_initialized',
							[$holder, options]
						);
...
(function ( $ ) {
	...
	var qodefYithClose = {
		init: function () {
			...
			if ( $holder.length ) {
				$holder.each(
					function () {
						$( this ).find( '.yith-wcqv-close' ).html( '<svg class="qodef-svg-close-lines" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="15px" height="15px" viewBox="0 0 15 15" enable-background="new 0 0 15 15" xml:space="preserve"><line fill="none" stroke="#000000" stroke-miterlimit="10" x1="2.197" y1="2.197" x2="12.803" y2="12.803"/><line fill="none" stroke="#000000" stroke-miterlimit="10" x1="2.197" y1="12.803" x2="12.803" y2="2.197"/></svg>' );
					}
				);
	...
	qodef.qodefYithClose = qodefYithClose;
